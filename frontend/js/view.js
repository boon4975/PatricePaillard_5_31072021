...
function viewAllProducts(dataProduct) {
        ...
        document.querySelector("#main").innerHTML += `
                                                    <div class="col-12 col-md-6 col-lg-4 card my-3 shadow">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <a href="produit.html?id=${dataProduct[i]._id}" rel="nofollow"><button id="${dataProduct[i]._id}" class="btn btn-secondary w-100">détails</button></a>
...
function viewProduct(dataProductSelected, categorie) {
    let option =[];
